...
#ifdef Old_Hero
#define PITCH_SPEED_PID_KP        2900.0f//2900.0f
#define PITCH_SPEED_PID_KI        25.0f//60.0f
...
#define YAW_GYRO_ABSOLUTE_PID_KD       0.3f// 3.4f//0.3f
...
#define YAW_SPEED_PID_KI        100.5f//15.0f
#define YAW_SPEED_PID_KD        0.30f
#define YAW_GYRO_ABSOLUTE_PID_KP        50.0f
#define YAW_GYRO_ABSOLUTE_PID_KI        50.0f
#define YAW_GYRO_ABSOLUTE_PID_KD        0.1f


#define YAW_SPEED_PID_MAX_OUT   25000.0f
#define YAW_SPEED_PID_MAX_IOUT  40.0f
#define YAW_SPEED_PID_MAX_DOUT  40.0f
#define YAW_GYRO_ABSOLUTE_PID_MAX_OUT   30000.0f
#define YAW_GYRO_ABSOLUTE_PID_MAX_IOUT  120.0f
#define YAW_GYRO_ABSOLUTE_PID_MAX_DOUT	20000.0f
*/
...
//云台初始化回中值的速度以及控制到的角度
#define GIMBAL_INIT_PITCH_SPEED     0.004f//0.004f
#define GIMBAL_INIT_YAW_SPEED       0.003f//0.005f

#define INIT_YAW_SET    0.0f
#define INIT_PITCH_SET  0.0f

//云台校准中值的时候，发送原始电流值，以及堵转时间，通过陀螺仪判断堵转
#define GIMBAL_CALI_MOTOR_SET   8000//8000
...
#define MIDDLE_YAW    1739
#define MIDDLE_PITCH  4500

#define MAX_PITCH  4950
#define MIN_PITCH  4010
...
//pitch gyro angle close-loop PID params, max out and max iout
//pitch 角度环 角度由陀螺仪解算 PID参数以及 PID最大输出，积分输出
#define PITCH_GYRO_ABSOLUTE_PID_KP 45.0f
#define PITCH_GYRO_ABSOLUTE_PID_KI 0.0f
#define PITCH_GYRO_ABSOLUTE_PID_KD 0.0f
