...
//    gimbal_PID_init_oldmethod(&init->gimbal_yaw_motor.gimbal_motor_absolute_angle_pid, YAW_GYRO_ABSOLUTE_PID_MAX_OUT, YAW_GYRO_ABSOLUTE_PID_MAX_IOUT,YAW_GYRO_ABSOLUTE_PID_MAX_DOUT, YAW_GYRO_ABSOLUTE_PID_KP, YAW_GYRO_ABSOLUTE_PID_KI, YAW_GYRO_ABSOLUTE_PID_KD, 0.001);
...
//		PID_init_oldmethod(&init->gimbal_yaw_motor.gimbal_motor_gyro_pid, PID_POSITION, Yaw_speed_pid, YAW_SPEED_PID_MAX_OUT, YAW_SPEED_PID_MAX_IOUT, YAW_SPEED_PID_MAX_DOUT , 0.001);
    //初始化pitch电机pid
...
//	gimbal_motor->current_set = gimbal_PID_calc(&gimbal_motor->gimbal_motor_absolute_angle_pid, 
//													gimbal_motor->absolute_angle, 
//													gimbal_motor->absolute_angle_set, 
//													gimbal_motor->motor_gyro);
